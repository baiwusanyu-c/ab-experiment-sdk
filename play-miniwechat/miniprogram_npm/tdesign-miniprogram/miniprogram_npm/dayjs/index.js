      ...
      return (
        ...
        (m.startOf = function (t, e) {
          const n = this,
            ...
            h = O.p(t),
            $ = function (t, e) {
              const i = O.w(n.$u ? Date.UTC(n.$y, e, t) : new Date(n.$y, e, t), n)
        ...
        (m.add = function (r, h) {
          ...
          if (l === a) return y(1)
          if (l === o) return y(7)
          const M = ((d = {}), (d[s] = e), (d[u] = n), (d[i] = t), d)[l] || 1,
        ...
        (m.format = function (t) {
          ...
          const r = t || 'YYYY-MM-DDTHH:mm:ssZ',
            i = O.z(this),
            s = this.$H,
            u = this.$m,
            a = this.$M,
