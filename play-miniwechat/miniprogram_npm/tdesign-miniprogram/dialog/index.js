...
export default {
  alert(options) {
    ...
    return new Promise(resolve => {
      instance.setData(
        Object.assign(Object.assign({ cancelBtn: '' }, otherOptions), { visible: true })
      )
  ...
  action(options) {
    const _a = Object.assign(Object.assign({}, defaultOptions), options),
      { context, selector, actions } = _a,
      otherOptions = __rest(_a, ['context', 'selector', 'actions'])
    const instance = getDialogInstance(context, selector)
    if (!instance) return Promise.reject()
    ...
    return new Promise(resolve => {
      instance.setData(
        Object.assign(Object.assign({ actions, buttonLayout: 'vertical' }, otherOptions), {
          visible: true,
        })
      )
