import { SuperComponent, useControl, wxComponent } from '../common/src/index'
...
let Swiper = class Swiper extends SuperComponent {
  ...
  initNav() {
    ...
    if (_navigation) {
      ...
      this.$nav =
        (_a = this.getRelationNodes('./swiper-nav')) === null || _a === void 0 ? void 0 : _a[0]
    }
  }
  inited() {
    this.updateNav(this.control.get())
  ...
  initCurrent() {
    ...
    this.control.set(
      index,
      Object.assign({ currentInited: true, inited: index === 0 }, this.calcOffset(index))
    )
  }
  play() {
    this.pause()
