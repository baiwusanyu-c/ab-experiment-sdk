  ...
  constructor() {
    ...
    this.methods = {
      ...
      getMinDate() {
        ...
        const startDate =
          disableDate === null || disableDate === void 0 ? void 0 : disableDate.before
      ...
      getDate() {
        ...
        return this.clipDate(
          ((_a = this.data) === null || _a === void 0 ? void 0 : _a.date) || DEFAULT_MIN_DATE
        )
      },
      clipDate(date) {
      ...
      onColumnChange(e) {
        ...
        const newValue = this.getNewDate(
          parseInt(value === null || value === void 0 ? void 0 : value.value, 10),
