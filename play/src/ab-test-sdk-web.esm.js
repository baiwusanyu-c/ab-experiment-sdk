...
// 设置web的请求脚本
setRequestInst(Promise.resolve().then(function () { return fetchWeb; }));
 ...
 * 发送请求
 */
async function sendRequest(url, headers, config) {
...
var fetchWeb = /*#__PURE__*/Object.freeze({
  __proto__: null,
  'default': request
});
